...
CREATE INDEX IF NOT EXISTS "like_profile_id_idx" ON "likes" USING btree ("profile_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "like_post_id_idx" ON "likes" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "post_hashtags_post_id_idx" ON "post_hashtags" USING btree ("post_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "post_hashtags_hashtag_id_idx" ON "post_hashtags" USING btree ("hashtag_id");--> statement-breakpoint
